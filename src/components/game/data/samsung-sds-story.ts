...
export const samsungSdsStorySteps: StoryStep[] = [
  ...
  },
  {
    id: "sloth-first-met",
    type: "story",
    text: "안녕하세요, 여기서 길을 잃으신 모양이군요 \n\n 제가... 도와드릴게요...",
    image: "/images/samsung-sds/sloth.png",
  },
  {
    id: "sloth-question1",
    type: "question",
    text: "그런데요, 프로님... 문제 하나 풀고 가시죠..?",
    question: "프로님, 요즘 프롬프트 엔지니어링 대신에 핫 한 게 뭔지 아시나요..?",
    correctAnswer: "컨텍스트 엔지니어링",
  },
  {
    id: "sloth-question2",
    type: "question",
    text: "역시 최.. 시... 이인... 트렌드를.. 잘 아시는군요.",
    question: "그렇다면 이 노.. 래... 제목 좀 알려주세요",
    correctAnswer: "사랑해도 될까요",
  },
  {
    id: "sloth-question3",
    type: "question",
    text: "하나만 더.....",
    question: "제가 요즘 좋우아 하아는 애니메이션이 있는데 이건 뭘까요오...?",
    correctAnswer: "케이팝 데몬 헌터스",
    image: "/images/samsung-sds/kpop-derpy.png",
  },
  {
    id: "story-ending",
    type: "story",
    text: "헤헤... 문제를 다 맞춰주신 기념으로 이 세계에서 탈출시켜드릴게요 🎉",
    image: "/images/samsung-sds/sloth-smash.png",
  },
  {
    id: "final-success",
    type: "success",
    text: "알람 소리를 듣고 깬 당신, \n\n 이 꿈은 무엇이었을까? \n\n 항상 노력해주는 스탭들에게 고마워해야겠다....",
    image: "/images/samsung-sds/wake-up.png",
  },
  {
    id: "elevator-failure",
    type: "failure",
